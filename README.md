...
The hyper dK-series is a family of randomization methods for hypergraphs [1]. 
...
- March 2025: Implemented Python code for the detection of higher-order rich clubs.

- September 2024: Implemented Python code with [Numba](https://numba.pydata.org/) for the hyper dK-series, achieving a **20–30× speedup** over the previous version for *d<sub>v</sub>* = 2 and 2.5 and comparable generation time to the C++ implementation. Randomized instances generated by the hyper dK-series in Python can be converted into a Hypergraph object in [HyperNetX](https://github.com/pnnl/HyperNetX).
