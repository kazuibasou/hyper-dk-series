...
- 2024/09/28: Implemented Python code with [numba](https://numba.pydata.org/) for the hyper dK-series, which is 20-30 times faster than the previous version for the parameter *d<sub>v</sub>* = 2 and 2.5 and achieves comparable generation time for C++ code. Randomized instances generated by the hyper dK-series can be converted to the Hypergraph object of [HyperNetX](https://github.com/pnnl/HyperNetX).
